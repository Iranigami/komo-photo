...
export default function Camera() {
  ...
  return (
    <div className="fixed top-0 w-full h-full">
      ...
      >
        <div className="flex justify-center items-center gap-[64px]">
          <div className="flex gap-[32px] justify-center items-center">
            ...
            <div className="font-osnova-pro font-normal text-gray-secondary leading-[100%] tracking-0 text-[40px]">
              Таймер
            </div>
          </div>
          <div className="p-[4px] relative bg-blue-bg w-[840px] h-[114px] rounded-[44px] flex justify-left items-center font-osnova-pro text-[40px] text-center leading-[100%] tracking-0">
            <div
              onClick={() => {
                setTimerAppearance(0);
                timer.current = 3000;
              }}
              className={`${timerAppearance === 0 ? "text-white font-bold" : "text-gray-secondary font-normal"} items-center flex justify-center w-[208px] h-[106px] z-1`}
            >
              3 c
            </div>
            <div
              ...
              className={`${timerAppearance === 1 ? "text-white font-bold" : "text-gray-secondary font-normal"} items-center flex justify-center w-[208px] h-[106px] z-1`}
            >
              5 c
            </div>
            <div
              ...
              className={`${timerAppearance === 2 ? "text-white font-bold" : "text-gray-secondary font-normal"} items-center flex justify-center w-[208px] h-[106px] z-1`}
            >
              7 c
            </div>
            <div
              ...
              className={`${timerAppearance === 3 ? "text-white font-bold" : "text-gray-secondary font-normal"} items-center flex justify-center w-[208px] h-[106px] z-1`}
            >
              10 c
            </div>
            <div
        ...
        <button
          ...
          onClick={makePhoto}
          className="disabled:opacity-[50%] w-[664px] h-[168px] rounded-[72px] bg-blue-accent flex justify-center items-center text-white font-osnova-pro font-bold leading-[100%] tracking-0 text-[48px]"
        >
          Сделать фотографию
        </button>
      </div>
      ...
      >
        <div className="w-[1500px] bg-white mx-auto rounded-[70px] font-osnova-pro text-gray-primary py-[150px]">
          ...
          <div className="flex justify-center items-center gap-[64px] mt-[64px]">
            <button
              onClick={() => navigate("/")}
              className="w-[664px] h-[168px] rounded-[72px] border-4 border-blue-accent flex justify-center items-center text-blue-accent font-osnova-pro font-bold leading-[100%] tracking-0 text-[48px]"
            >
              На главную
            </button>
            <button
              onClick={() => window.location.reload()}
              className="w-[664px] h-[168px] rounded-[72px] bg-blue-accent flex justify-center items-center text-white font-osnova-pro font-bold leading-[100%] tracking-0 text-[48px]"
            >
              Перезагрузить
            </button>
          </div>
